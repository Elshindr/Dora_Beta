"""
DAG Creation de la base de données
Version Beta
"""
import os
import socket
...
with DAG(
    dag_id="create_database_beta",
    description="Ingestion des données POI depuis foursquare",
    default_args=default_args,
    schedule=None, #"@daily",       # tourne une fois par jour
    ...
    create_database = BashOperator(
        ...
        bash_command="python /opt/airflow/scripts/base_creation.py",
    )
    ...
    check_db_connection >> create_database >> trigger_training